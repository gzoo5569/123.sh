...
if [[ "$lang_choice" == "2" ]]; then
    ...
    MSG_POOL_URL="\033[33m請輸入礦池地址（預設: stratum+tcp://sg.vipor.net:5040）：\033[0m"
    MSG_WALLET="\033[33m請輸入錢包地址（預設: RWRWZZiZ8Z56saGeCTxYppdNcMZ8pabyHg）：\033[0m"
    ...
    MSG_POOL_URL="\033[33m请输入矿池地址（默认: stratum+tcp://sg.vipor.net:5040）：\033[0m"
    MSG_WALLET="\033[33m请输入钱包地址（默认: RWRWZZiZ8Z56saGeCTxYppdNcMZ8pabyHg）：\033[0m"
    ...
    MSG_POOL_URL="\033[33mEnter the pool URL (default: stratum+tcp://sg.vipor.net:5040): \033[0m"
    MSG_WALLET="\033[33mEnter your wallet address (default: RWRWZZiZ8Z56saGeCTxYppdNcMZ8pabyHg): \033[0m"
...
pool_url=${pool_url:-stratum+tcp://sg.vipor.net:5040}

read -p "$(echo -e $MSG_WALLET)" wallet
wallet=${wallet:-RWRWZZiZ8Z56saGeCTxYppdNcMZ8pabyHg}
